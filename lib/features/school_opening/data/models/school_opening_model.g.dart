...
_SchoolOpeningModel _$SchoolOpeningModelFromJson(Map<String, dynamic> json) => _SchoolOpeningModel(
...
Map<String, dynamic> _$SchoolOpeningModelToJson(_SchoolOpeningModel instance) => <String, dynamic>{
  'id': instance.id,
