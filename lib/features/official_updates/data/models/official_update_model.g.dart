...
_OfficialUpdateModel _$OfficialUpdateModelFromJson(Map<String, dynamic> json) =>
    _OfficialUpdateModel(
      ...
      priority:
          $enumDecodeNullable(_$UpdatePriorityEnumMap, json['priority']) ??
          UpdatePriority.normal,
      targetAudience:
          $enumDecodeNullable(
            _$UpdateAudienceEnumMap,
            json['targetAudience'],
          ) ??
          UpdateAudience.all,
...
Map<String, dynamic> _$OfficialUpdateModelToJson(
  _OfficialUpdateModel instance,
) => <String, dynamic>{
  'id': instance.id,
