...
_StatementModel _$StatementModelFromJson(Map<String, dynamic> json) =>
    _StatementModel(
      ...
      status:
          $enumDecodeNullable(_$StatementStatusEnumMap, json['status']) ??
...
Map<String, dynamic> _$StatementModelToJson(_StatementModel instance) =>
    <String, dynamic>{
      'id': instance.id,
