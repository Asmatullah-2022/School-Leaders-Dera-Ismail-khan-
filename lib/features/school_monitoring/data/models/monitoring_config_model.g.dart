...
_MonitoringConfigModel _$MonitoringConfigModelFromJson(Map<String, dynamic> json) =>
...
Map<String, dynamic> _$MonitoringConfigModelToJson(_MonitoringConfigModel instance) =>
    <String, dynamic>{
