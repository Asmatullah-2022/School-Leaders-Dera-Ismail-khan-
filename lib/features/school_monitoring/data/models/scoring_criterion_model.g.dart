...
_ScoringCriterionModel _$ScoringCriterionModelFromJson(Map<String, dynamic> json) =>
...
Map<String, dynamic> _$ScoringCriterionModelToJson(_ScoringCriterionModel instance) =>
    <String, dynamic>{
      'id': instance.id,
...
_GradeBandModel _$GradeBandModelFromJson(Map<String, dynamic> json) => _GradeBandModel(
  grade: json['grade'] as String,
  minScore: (json['minScore'] as num).toDouble(),
  maxScore: (json['maxScore'] as num).toDouble(),
);

Map<String, dynamic> _$GradeBandModelToJson(_GradeBandModel instance) => <String, dynamic>{
...
Map<String, dynamic> _$CriterionScoreModelToJson(_CriterionScoreModel instance) =>
    <String, dynamic>{
