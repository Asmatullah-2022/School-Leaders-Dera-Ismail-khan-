...
_EmergencyReportModel _$EmergencyReportModelFromJson(Map<String, dynamic> json) =>
    _EmergencyReportModel(
      ...
      status: $enumDecodeNullable(_$EmergencyStatusEnumMap, json['status']) ?? EmergencyStatus.open,
...
Map<String, dynamic> _$EmergencyReportModelToJson(_EmergencyReportModel instance) =>
    <String, dynamic>{
      'id': instance.id,
