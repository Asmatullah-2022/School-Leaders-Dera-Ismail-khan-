...
_AdvertisementCampaignModel _$AdvertisementCampaignModelFromJson(Map<String, dynamic> json) =>
    _AdvertisementCampaignModel(
      ...
      advertisementType: $enumDecode(_$AdvertisementTypeEnumMap, json['advertisementType']),
...
Map<String, dynamic> _$AdvertisementCampaignModelToJson(_AdvertisementCampaignModel instance) =>
    <String, dynamic>{
      'id': instance.id,
