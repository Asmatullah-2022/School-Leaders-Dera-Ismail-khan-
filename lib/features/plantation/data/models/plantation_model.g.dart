...
_PlantationModel _$PlantationModelFromJson(Map<String, dynamic> json) =>
    _PlantationModel(
...
Map<String, dynamic> _$PlantationModelToJson(_PlantationModel instance) =>
    <String, dynamic>{
      'id': instance.id,
