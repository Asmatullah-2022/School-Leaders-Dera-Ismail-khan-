...
_SchoolFunctionalityModel _$SchoolFunctionalityModelFromJson(Map<String, dynamic> json) =>
    _SchoolFunctionalityModel(
      ...
      learningEnvironmentSatisfactory: json['learningEnvironmentSatisfactory'] as bool? ?? false,
      overallStatus:
          $enumDecodeNullable(_$FunctionalityStatusEnumMap, json['overallStatus']) ??
...
Map<String, dynamic> _$SchoolFunctionalityModelToJson(_SchoolFunctionalityModel instance) =>
    <String, dynamic>{
      'id': instance.id,
