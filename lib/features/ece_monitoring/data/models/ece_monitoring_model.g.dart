...
_EceMonitoringModel _$EceMonitoringModelFromJson(Map<String, dynamic> json) =>
    _EceMonitoringModel(
      ...
      learningMaterialsAvailable:
          json['learningMaterialsAvailable'] as bool? ?? false,
      ...
      cleanlinessSatisfactory:
          json['cleanlinessSatisfactory'] as bool? ?? false,
      ...
      status:
          $enumDecodeNullable(_$EceStatusEnumMap, json['status']) ??
          EceStatus.needsImprovement,
...
Map<String, dynamic> _$EceMonitoringModelToJson(_EceMonitoringModel instance) =>
    <String, dynamic>{
      'id': instance.id,
