...
_SchoolProblemModel _$SchoolProblemModelFromJson(Map<String, dynamic> json) =>
    _SchoolProblemModel(
      ...
      priority:
          $enumDecodeNullable(_$ProblemPriorityEnumMap, json['priority']) ??
      ...
      resolutionEvidenceUrls:
          (json['resolutionEvidenceUrls'] as List<dynamic>?)
              ?.map((e) => e as String)
              .toList() ??
          const <String>[],
...
Map<String, dynamic> _$SchoolProblemModelToJson(
  _SchoolProblemModel instance,
) => <String, dynamic>{
  'id': instance.id,
