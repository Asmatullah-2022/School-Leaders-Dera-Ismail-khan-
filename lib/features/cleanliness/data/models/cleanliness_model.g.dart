...
_CleanlinessModel _$CleanlinessModelFromJson(Map<String, dynamic> json) => _CleanlinessModel(
  ...
  beforePhotoUrls:
      (json['beforePhotoUrls'] as List<dynamic>?)?.map((e) => e as String).toList() ??
      const <String>[],
  evidencePhotoUrls:
...
Map<String, dynamic> _$CleanlinessModelToJson(_CleanlinessModel instance) => <String, dynamic>{
  'id': instance.id,
