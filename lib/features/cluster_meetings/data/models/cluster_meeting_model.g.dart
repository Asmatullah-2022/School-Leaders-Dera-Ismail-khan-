...
_ClusterMeetingModel _$ClusterMeetingModelFromJson(Map<String, dynamic> json) =>
    _ClusterMeetingModel(
      ...
      participatingSchoolIds:
          (json['participatingSchoolIds'] as List<dynamic>?)?.map((e) => e as String).toList() ??
          const <String>[],
      agenda: json['agenda'] as String?,
      agendaUrdu: json['agendaUrdu'] as String?,
      decisions: json['decisions'] as String?,
      minutes: json['minutes'] as String?,
      status: $enumDecodeNullable(_$MeetingStatusEnumMap, json['status']) ?? MeetingStatus.pending,
      evidencePhotoUrls:
...
Map<String, dynamic> _$ClusterMeetingModelToJson(_ClusterMeetingModel instance) =>
    <String, dynamic>{
      'id': instance.id,
...
_MeetingActionModel _$MeetingActionModelFromJson(Map<String, dynamic> json) => _MeetingActionModel(
  id: json['id'] as String,
...
Map<String, dynamic> _$MeetingActionModelToJson(_MeetingActionModel instance) => <String, dynamic>{
  'id': instance.id,
