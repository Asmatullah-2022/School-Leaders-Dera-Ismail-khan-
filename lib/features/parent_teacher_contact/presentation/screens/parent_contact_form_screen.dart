      ...
      body: Form(
        ...
        child: ListView(
          ...
          children: <Widget>[
            ...
            const SizedBox(height: 12),
            AppTextField(label: l10n.parentContact_discussion, controller: _discussion, maxLines: 3),
            const SizedBox(height: 12),
            ...
            if (_followUpRequired) ...<Widget>[
              InkWell(
                ...
                child: InputDecorator(
                  ...
                  child: Text(
                    _followUpDate == null ? l10n.common_selectOption : DateFormat.yMMMd().format(_followUpDate!),
                  ),
                ),
              ),
              const SizedBox(height: 12),
