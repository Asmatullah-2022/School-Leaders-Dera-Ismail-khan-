...
_CommunityActivityModel _$CommunityActivityModelFromJson(
  ...
  activityType: $enumDecode(
    _$CommunityActivityTypeEnumMap,
    json['activityType'],
  ),
  ...
  femaleParticipantsCount:
      (json['femaleParticipantsCount'] as num?)?.toInt() ?? 0,
...
Map<String, dynamic> _$CommunityActivityModelToJson(
  _CommunityActivityModel instance,
) => <String, dynamic>{
  'id': instance.id,
