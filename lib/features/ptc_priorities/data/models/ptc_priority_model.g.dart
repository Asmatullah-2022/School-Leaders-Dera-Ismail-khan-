...
_PtcPriorityModel _$PtcPriorityModelFromJson(Map<String, dynamic> json) =>
    _PtcPriorityModel(
      ...
      status:
          $enumDecodeNullable(_$PtcStatusEnumMap, json['status']) ??
          PtcStatus.proposed,
      evidencePhotoUrls:
...
Map<String, dynamic> _$PtcPriorityModelToJson(_PtcPriorityModel instance) =>
    <String, dynamic>{
      'id': instance.id,
