...
_AdmissionCampaignModel _$AdmissionCampaignModelFromJson(Map<String, dynamic> json) =>
    _AdmissionCampaignModel(
      ...
      freeTextbooksDistributed: (json['freeTextbooksDistributed'] as num?)?.toInt() ?? 0,
      otherSupport: json['otherSupport'] as String?,
      remarks: json['remarks'] as String?,
      remarksUrdu: json['remarksUrdu'] as String?,
      date: DateTime.parse(json['date'] as String),
      status: $enumDecodeNullable(_$CampaignStatusEnumMap, json['status']) ?? CampaignStatus.active,
      achievementPercentage: (json['achievementPercentage'] as num?)?.toDouble() ?? 0.0,
      evidencePhotoUrls:
...
Map<String, dynamic> _$AdmissionCampaignModelToJson(_AdmissionCampaignModel instance) =>
    <String, dynamic>{
      'id': instance.id,
