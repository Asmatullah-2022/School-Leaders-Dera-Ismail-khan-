...
_OoscRecordModel _$OoscRecordModelFromJson(Map<String, dynamic> json) => _OoscRecordModel(
  ...
  status: $enumDecodeNullable(_$OoscStatusEnumMap, json['status']) ?? OoscStatus.identified,
...
Map<String, dynamic> _$OoscRecordModelToJson(_OoscRecordModel instance) => <String, dynamic>{
  'id': instance.id,
...
const _$OoscGenderEnumMap = {OoscGender.male: 'male', OoscGender.female: 'female'};
