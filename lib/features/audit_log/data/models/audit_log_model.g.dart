...
_AuditLogModel _$AuditLogModelFromJson(Map<String, dynamic> json) => _AuditLogModel(
...
Map<String, dynamic> _$AuditLogModelToJson(_AuditLogModel instance) => <String, dynamic>{
  'id': instance.id,
