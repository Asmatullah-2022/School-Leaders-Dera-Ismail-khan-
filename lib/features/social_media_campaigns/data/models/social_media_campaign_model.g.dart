...
_SocialMediaCampaignModel _$SocialMediaCampaignModelFromJson(Map<String, dynamic> json) =>
...
Map<String, dynamic> _$SocialMediaCampaignModelToJson(_SocialMediaCampaignModel instance) =>
    <String, dynamic>{
      'id': instance.id,
